...
ggplotly(filmes %>%
    ...
    geom_point() +
    theme_bw() +
    ggtitle("Bilheteria (em Doláres) vs Avaliação do Rotten Tomatoes"), tooltip = c("label", "label2"))
...
ggdendrogram(agrupamento, rotate = T, size = 2) + 
    labs(x = "", y = "") +
    ggtitle("Níveis de similaridade entre os filmes")
...
ggplotly(atribuicoes %>%
    ...
    geom_point() +
    theme_bw() +
    ggtitle("Os 3 tipos de filme de Cillian Murphy"), tooltip = c("label", "label2"))
